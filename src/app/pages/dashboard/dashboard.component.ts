  ...
  DashboardCards: CardDetails[] = [
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="darkblue" class="size-6">
...
`
    },
    {
      ...
      change: '-5%',
      changeLabel: 'vs. previous month',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="magenta" class="size-6">
...
`
    },
    {
      ...
      change: '+40%',
      changeLabel: 'vs. previous month',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="green" class="size-6">
...
`
    },
    {
      ...
      change: '+8%',
      changeLabel: 'vs. previous month',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="purple" class="size-6">
...
`
    },
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="orange" class="size-6">
